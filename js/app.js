		...
		for (let index = 0; index < inputs.length; index++) {
			...
			if (input.classList.contains('_date')) {
				const calendarItem = datepicker(input, {
					...
					customMonths: ["Січ.", "Лют.", "Бер.", "Квiт.", "Трав.", "Черв.", "Лип.", "Серп.", "Вер.", "Жовт.", "Лист.", "Груд."],
...
let sliderConsultation = new Swiper('.slider-consultation', {
	...
	*/
	...
	// Dotts
	pagination: {
		el: '.conrol-slider__dotts',
		clickable: true,
	},
	// Arrows
	navigation: {
		nextEl: '.conrol-slider__arrow_next',
		prevEl: '.conrol-slider__arrow_prev',
	},
	/*
	breakpoints: {
		320: {
...
let sliderReviews = new Swiper('.slider-reviews', {
	...
	*/
	...
	// Dotts
	pagination: {
		el: '.conrol-slider-reviews__dotts',
		clickable: true,
	},
	// Arrows
	navigation: {
		nextEl: '.conrol-slider-reviews__arrow_next',
		prevEl: '.conrol-slider-reviews__arrow_prev',
	},
	/*
	breakpoints: {
		320: {
